...
train_dir  = Path("~/Documents/potato_disease_detection/dataset/train/Late_Blight").expanduser()
val_dir    = Path("~/Documents/potato_disease_detection/dataset/val/Late_Blight").expanduser()
